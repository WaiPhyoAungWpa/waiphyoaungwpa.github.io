...
export const skillGroups: SkillGroup[] = [
  ...
  },
  {
    ...
    featured: true,
    skills: [
      { name: 'React.js', featured: true, category: 'frameworks' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'MySQL', featured: true, category: 'databases' },
  ...
  },
  {
    ...
    skills: [
      { name: 'GitHub', featured: true, category: 'tools' },
      { name: 'Visual Studio Code', featured: true, category: 'tools' },
      ...
      { name: 'Orange Data Mining', category: 'tools' },
    ],
  },
  {
    ...
    featured: true,
    skills: [
      { name: 'Power Apps', category: 'lowcode' },
      { name: 'Power Automate', featured: true, category: 'lowcode' },
      { name: 'Power BI', category: 'lowcode' },
      { name: 'Jira Automation', featured: true, category: 'lowcode' },
      { name: 'Mendix Studio', featured: true, category: 'lowcode' },
    ],
  },
  {
    title: 'Practices & Methods',
    skills: [
      { name: 'Software Engineering Practices', featured: true, category: 'practices' },
      { name: 'CI/CD Workflows', category: 'practices' },
    ],
  },
]
